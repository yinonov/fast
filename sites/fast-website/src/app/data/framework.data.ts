export interface FrameworkContentCard {
    divider?: boolean;
    header?: string;
    body?: string;
...
const frameworkReusableAttributes: FrameworkContentCard = {
    divider: true,
...
export const frameworkContentCardList: FrameworkContentCard[] = [
    {
